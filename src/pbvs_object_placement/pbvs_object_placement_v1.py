...
def main():
    ...
    transform_camera2_fname = sys.argv[5]
    ...
    desired_camera2_transform_msg = TransformStamped()
        
    with open(transform_fname,'r') as f:
        transform_yaml = yaml.load(f)
    with open(transform_camera2_fname,'r') as f:
        transform_camera2_yaml = yaml.load(f)
        
    genpy.message.fill_message_args(desired_transform_msg, transform_yaml)
    genpy.message.fill_message_args(desired_camera2_transform_msg, transform_camera2_yaml)
    
    goal = PBVSPlacementGoal()
    goal.desired_transform = desired_transform_msg
    goal.desired_camera2_transform = desired_camera2_transform_msg
...
class PBVSPlacementController(object):
    ...
    def set_goal(self, params_msg):
        ...
        self.desired_camera2_transform=rox_msg.msg2transform(params_msg.desired_camera2_transform)
